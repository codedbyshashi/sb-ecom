  ...
  return(
    <div className="flex lg:flex-row flex-col-reverse lg:justify-between justify-center items-center gap-4 ">
      ...
      <div className="flex sm:flex-row flex-col gap-4 items-center">
        ...
        {/* CLEAR FILTER BUTTON */}
        <button
        className="flex items-center gap-2 bg-rose-900 text-white px-3 py-2 cursor-pointer rounded-md transition duration-300 ease-in shadow-md focus:outline-none ">
