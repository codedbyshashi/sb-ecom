  ...
  return (
    <>
      <Dialog open={open} as="div" className="relative z-10" onClose={close} __demoMode>
        <DialogBackdrop className="fixed inset-0 bg-gray-500 bg-opacity-75 trasition-opacity" />
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <button onClick={() => setOpen(false)}
                type='button'
                className='px-4 py-2 text-sm font-semibold text-slate-700 border border-amber-800 rounded-lg cursor-pointer'>Close</button> 
            </div>
